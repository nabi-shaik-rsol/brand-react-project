...
const hasTriggeredRef = useRef(false);
    // skip initial mount animations
    const [skipInitial, setSkipInitial] = useState(true);
    useEffect(() => {
        const t = setTimeout(() => setSkipInitial(false), 50);
 ...
 useEffect(() => {
    ...
    return (
        <div className="container mx-auto w-3/4 px-20 p-4">
            {/* <div ref={gridRef} data-visible={cardsVisible} className={`grid grid-cols-12 gap-2 [grid-auto-flow:dense]  ${cardsVisible ?"services-grid" :"" }`}> */}
                ...
                {orderedServices.map((service, index) => {
                    ...
                    return (
                        <motion.div
                                    ...
                                    // style={{ "--i": index }}
                                    transition={{ duration: skipInitial ? 0 : 0.6 }}
                                ...
                                <AnimatePresence mode="wait">
                                    {isActive ? (
                                        <motion.div
                                            ...
                                            initial={skipInitial ? false : { rotateY: 180 }}
                                            animate={{ rotateY: 0 }}
                                            exit={{ rotateY: 180 }}
                                            transition={{ duration: skipInitial ? 0 : 0.6 }}
                                        >
