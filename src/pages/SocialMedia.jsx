...
import Timer from "../../assets/icons/Social Media@300x.png";
...
const SocialMedia = () => {
    ...
    const services = [
        { title: "Social Media\nStrategy &\nPlanning ", color: "bg-[#c31c26]" },
        { title: "Content\n Creation &\nManagement", color: "bg-[#00974d]" },
        { title: " Paid Social\n Campaigns", color: "bg-[#008fbf]" },
        { title: "Influencer &\nCreator \nMarketing", color: " bg-[#d37548]" },
        { title: " Real-Time\nActivations", color: " bg-[#c98e27] " },
        { title: "Community\nEngagement", color: " bg-[#761a5b] " },
        { title: " Analytics &\nReporting", color: "  bg-[#00aa7d]" },
    ...
    return (
        <div className="relative  lg:justify-evenly md:justify-between sm:justify-center w-full xs:items-center items-baseline min-h-screen mx-auto bg-black text-white overflow-hidden   
                                                2xl:px-40 xl:px-35 lg:px-20 md:px-11 px-6 3xl:pt-36 2xl:pt-10 xl:pt-8 lg:pt-8 md:pt-8 pt-10 lg:pb-8 md:pb-8  pb-8  
                                                       " >
            ...
            <div className='flex justify-between items-baseline   '>
                ...
                <div className='flex justify-end py-5 md:pr-0 pr-5 w-full' >
                    <img src={Timer} className='activations-timer 2xl:w-28 2xl:h-28 lg:w-20 lg:h-20 md:w-[70px] md:h-[70px] sm:w-14 sm:h-14  xs:w-14 xs:h-14  w-14 h-14' alt='...' />
                </div>
            </div>
            <div className="relative flex flex-col lg:flex-row  2xl:justify-between lg:justify-between md:justify-between sm:justify-center w-full md:items-baseline items-start min-h-fit mx-auto  text-white overflow-hidden 2xl:gap-32  lg:gap-20 md:gap-5  ">
                ...
                <div className="5xl:w-[40%]   2xl:w-[40%] lg:w-[38%] md:w-[100%] sm:w-[100%] w-[100%]  z-10">

                    <div className="w-full">
                        <h2
                            id="activationsSubHeading"
                            className="2xl:text-[68px] lg:w-[102%] md:w-full xl:text-[42px] md:text-[40px] text-[35px] text-bolder  mb-8 tracking-wide 2xl:leading-[4.5rem] xl:leading-[50px] leading-[2.6rem] md:leading-[2.7rem] subHeadingAnimation"
                        ...
                        <div className="space-y-6  5xl:text-[32px] 5xl:leading-13  2xl:text-[18px]  lg:text-[12px] xs:text-[10px] text-[12px] xs:leading-[1rem] leading-[1.3rem] text-gray-300  2xl:leading-[1.5rem] tracking-wider md:mb-8 sm:mb-8 mb-10" style={{ fontFamily: "Montserrat-Light" }}>
                            <p id="activationsParagraph">
                                In today's digital-first world, social media is more than just posting—
                                it's where your brand breathes. At Brain Wave, we don't just manage
                                pages, we engineer engagement. From strategy to storytelling, we craft
                                tailored content, campaigns, and activations that spark attention,
                                inspire action, and turn followers into brand advocates.
                            </p>
                ...
                <div className="justify-end flex flex-col lg:w-[68%] md:w-[100%] sm:w-[100%] w-[100%] xs:w-[100%] items-start z-10 lg:pl-0 md:pl-0 xs:pl-0 pl-0">
                    ...
                    <div className='w-full flex items-end'>
                        <h3 id="activationsWhatWeDo" className="text-[25px] w-full lg:text-[30px]  xl:text-[35px] 5xl:text-[70px] 5xl:leading-25 md:text-[30px] 2xl:text-[45px] xs:text-[25px] font-light mb-7  tracking-wide 2xl:leading-[45px] xl:leading-[40px] sm:leading-[2rem] xs:leading-[1.5rem] leading-[2rem] subHeadingAnimation  " style={{ fontFamily: "PoppinsLight" }}>
                            <span>Our Social Media Services &</span>  <br />
                    ...
                    >
                        {services.map((service, index) => (
                            <div
                                key={index}
                                tabIndex={index}
                                className={`${service.color} lg:p-4 grid-item  md:p-4 p-2  3xl:h-52 3xl:w-52 2xl:h-48 2xl:w-48 xl:w-[140px] xl:h-[140px] md:w-28 sm:w-28 gap-2  md:h-28 sm:h-28 w-[120px] h-[120px]  flex flex-col justify-between transition-all duration-300 hover:scale-105 cursor-pointer`}
