...
import Timer from "../../assets/icons/Activation Main icon@300x.png";
...
const Activations = () => {
    const services = [
        { title: "Product\nLaunch\nActivations", color: "bg-[#c31c26]" },
        { title: "Experiential\nMarketing", color: "bg-[#00974d]" },
        { title: "In-Mall &\nRetail\nActivation", color: "bg-[#008fbf]" },
        { title: "Outdoor &\nRoadshow\nActivations", color: "bg-[#d37548]" },
        { title: "CSR &\nAwareness\nDrives", color: "bg-[#c98e27]" },
        { title: "Community-\nbuilding\nactivations", color: "bg-[#761a5b]" },
        { title: "Corporate\n& Internal\nActivations", color: "bg-[#00aa7d]" },
        { title: "Seasonal &\nFestival\nActivations", color: "bg-[#e2496d]" }
    ];
    ...
    return (
        <div className="relative bg-black min-h-screen pb-10 w-[100%] overflow-hidden flex-col items-center  ">
            <div className='absolute  items-center my-auto  inset-0 min-h-screen w-[110%] z-10'>

                <Wave.Animated className="   pointer-events-none" speed={100} paused={false} />
            </div>
            ...
            <div className="relative  lg:justify-evenly md:justify-between sm:justify-center w-full xs:items-center items-baseline min-h-screen mx-auto bg-black text-white overflow-hidden   
                                                2xl:px-40 xl:px-35 lg:px-20 md:px-11 px-6 3xl:pt-28 2xl:pt-20 xl:pt-8 lg:pt-8 md:pt-8 pt-10 lg:pb-8 md:pb-8  pb-8  
                                                       " >

                <div className='flex justify-between items-baseline   '>
                    <h3 id="activationsStrat" className="text-[25px] items-start xl:text-[35px] lg:text-[30px] md:text-[30px] 2xl:text-[45px] xs:text-[25px] font-light tracking-wide leading-[2rem] 5xl:text-[70px] 5xl:leading-[4.5rem] 2xl:leading-[3rem] xl:leading-[3rem] md:leading-[1.5rem] xs:leading-[1.3rem] subHeadingAnimation" style={{ fontFamily: "PoppinsLight" }}>
                ...
                <div className="relative flex flex-col lg:flex-row  2xl:justify-between lg:justify-between md:justify-between sm:justify-center w-full md:items-baseline items-start min-h-fit mx-auto  text-white overflow-hidden 2xl:gap-32  lg:gap-20 md:gap-5  ">
                    ...
                    <div className="    5xl:w-[40%]   2xl:w-[35%] lg:w-[35%] md:w-[100%] sm:w-[100%] w-[100%]  z-10">
                        ...
                        <div className="w-full">
                            <h2
                                ...
                                className="2xl:text-[70px] xl:text-[45px] md:text-[40px] text-[35px] text-bolder  mb-8 tracking-wide 2xl:leading-[4.5rem] xl:leading-[60px] leading-[2.6rem] md:leading-[2.7rem] subHeadingAnimation"
                                style={{ fontFamily: "PoppinsRegular" }}
                            >
                                <span>Where Brands</span><br />
                            ...
                            <div className="space-y-6  5xl:text-[32px] 5xl:leading-13  2xl:text-[18px]  lg:text-[12px] xs:text-[10px] text-[12px] xs:leading-[1rem] leading-[1.3rem] text-gray-300  2xl:leading-[1.5rem] tracking-wider md:mb-8 sm:mb-8 mb-10" style={{ fontFamily: "Montserrat-Light" }}>
                                <p id="activationsParagraph">
                                    At Brain Wave, we don't just communicate messages-we activate
                                    them. From streets to showrooms, from events to experiential zones,
                                    our activations are designed to spark conversations, ignite
                                    engagement, and turn passive audiences into passionate advocates.
                                    Whether it's launching a new product, energizing a brand, or creating
                                    memorable consumer touchpoints, our activation strategies ensure
                                    your brand doesn't just show up-it shows off.
                                </p>
                    ...
                    <div className="justify-end flex flex-col lg:w-[63%] md:w-[100%] sm:w-[100%] w-[100%] xs:w-[100%] items-start z-10 lg:pl-0 md:pl-0 xs:pl-0 pl-0">


                        <div className='w-full flex items-end'>
                            <h3 id="activationsWhatWeDo" className="text-[35px]  xl:text-[35px] 5xl:text-[70px] 5xl:leading-25 md:text-[30px] 2xl:text-[45px] xs:text-[18px] font-light mb-7  tracking-wide 2xl:leading-[45px] xl:leading-[40px] sm:leading-[2rem] xs:leading-[1.5rem] leading-[2rem] subHeadingAnimation  " style={{ fontFamily: "PoppinsLight" }}>
                                <span>What We Do -</span> <br />
                                <span> Our Activation Expertise:</span>
                            </h3>
                        </div>
                            ...
                            {services.map((service, index) => (
                                ...
                                >
                                    <div className="card-inner w-full h-full flex flex-col justify-between">
                                        <div>
                                            <h3 className="text-white  5xl:text-4xl 2xl:text-[24px] xl:text-[16px] md:text-[12px]  text-[14px] font-medium leading-tight whitespace-pre-line  tracking-wide" style={{ fontFamily: "Montserrat-Regular" }}>
                                                {service.title}
                                            </h3>
                                        </div>
