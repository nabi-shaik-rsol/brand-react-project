...
import Timer from "../../assets/icons/Video Graphy@300x.png";
import './Advertising.css';
import Arrow from "../../assets/icons/left-arrow.png";
import Wave from './Wave';
import { useNavigate } from 'react-router-dom';
const VideographyPhotgraphy = () => {

    const services = [
        { title: " Corporate & \nBrand Films", color: "bg-[#e2496d]" },
        { title: "Product & \nCommercial \nShoots", color: "bg-[#00aa7d]" },
        { title: " Event\n Coverage", color: "bg-[#761a5b]" },
        { title: " Automotive&\n Industrial \nShoots", color: "bg-[#c98e27]" },
        { title: " Social Media \nContent", color: "bg-[#d37548]" },
        { title: "Aerial & \nDrone \nFilming", color: "bg-[#008fbf]" },
        { title: " Lifestyle & \nPortrait \nPhotography", color: "bg-[#00974d]" },
        { title: "Documentary \n& CSR\n Projects", color: "bg-[#c31c26]" }
    ];
        ...
        const triggerAnimationIfVisible = () => {
            const animateEl = (el) => {
                ...
                spans.forEach((span, i) => {
                    span.style.animation = `fade-in 0.8s ${i * 0.08}s forwards cubic-bezier(0.11, 0, 0.5, 0)`;
                });
                return true;
            };
    ...
    return (
        <div className="relative  lg:justify-evenly md:justify-between sm:justify-center w-full xs:items-center items-baseline min-h-screen mx-auto bg-black text-white overflow-hidden   
            ...
            <div className='flex justify-between items-baseline  z-10  '>
                <h3 id="activationsStrat" className="text-[25px] w-[110%] items-start xl:text-[35px] lg:text-[30px] md:text-[30px] 2xl:text-[45px] sm:text-[24px] xs:text-[25px] font-light tracking-wide leading-[2rem] 5xl:text-[70px] 5xl:leading-[4.5rem] 2xl:leading-[3rem] xl:leading-[3rem] lg:leading-[2.2rem] md:leading-[2rem] xs:leading-[1.8rem] subHeadingAnimation" style={{ fontFamily: "PoppinsLight" }}>
                    ...
                    <div className="w-full">
                        ...
                        <div className="space-y-6  5xl:text-[32px] 5xl:leading-13  2xl:text-[18px]  lg:text-[12px] xs:text-[10px] text-[12px] xs:leading-[1rem] leading-[1.3rem] text-gray-300  2xl:leading-[1.5rem] tracking-wider md:mb-8 sm:mb-8 mb-10" style={{ fontFamily: "Montserrat-Light" }}>
                            <p id="activationsParagraph">
                                At Brain Wave, we don't just shoot visuals—we craft stories. Our
                                videography and photography services are designed to capture the
                                soul of your brand and bring it to life through high-quality,
                                purpose-driven content. Whether it's for a product launch, event
                                coverage, commercial shoot, or social campaign, we turn every frame
                                into a visual experience that connects and communicate.
                            </p>
                ...
                <div className="justify-end flex flex-col lg:w-[65%] md:w-[100%] sm:w-[100%] w-[100%] xs:w-[100%] items-start z-10 lg:pl-0 md:pl-0 xs:pl-0 pl-0">
                    ...
                    <div className='w-full flex items-end'>
                        <h3 id="activationsWhatWeDo" className="text-[25px] w-full lg:text-[30px]  xl:text-[35px] 5xl:text-[70px] 5xl:leading-25 md:text-[30px] 2xl:text-[45px] xs:text-[25px] font-light mb-7  tracking-wide 2xl:leading-[45px] xl:leading-[40px]  sm:leading-[2rem] xs:leading-[1.5rem] leading-[2rem] subHeadingAnimation  " style={{ fontFamily: "PoppinsLight" }}>
                            <span>Our Videography &</span>  <br />
                            <span>Photography  Services Include:</span>
                        </h3>
                    </div>
...
export default VideographyPhotgraphy;