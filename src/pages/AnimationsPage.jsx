...
import Timer from "../../assets/icons/Animation@300x.png";
...
const AnimationsPage = () => {
    ...
    const services = [
        { title: "2D\nAnimation", color: "bg-[#e2496d]" },
        { title: "3D\nAnimation", color: "bg-[#00aa7d]" },
        { title: "Motion\nGraphics", color: "bg-[#761a5b]" },
        { title: "Animated\nCommercials", color: "bg-[#c98e27]" },
        { title: "Social Media\nAnimation", color: "bg-[#d37548]" },
        { title: "Kinetic\nTypography", color: "bg-[#008fbf]" },
        { title: "Augmented\nReality\nAnimations", color: "bg-[#00974d]" },
        { title: "Event &\nStage\nAnimations", color: "bg-[#c31c26]" }
    ];
                ...
                <div className="    5xl:w-[40%]   2xl:w-[35%] lg:w-[35%] md:w-[100%] sm:w-[100%] w-[100%]  z-10">
                    ...
                    <div className="w-full">
                        <h2
                            ...
                            className="2xl:text-[70px] xl:text-[42px] md:text-[40px] text-[35px] text-bolder  mb-8 tracking-wide 2xl:leading-[4.5rem] xl:leading-[60px] leading-[2.6rem] md:leading-[2.7rem] subHeadingAnimation"
                        ...
                        <div className="space-y-6  5xl:text-[32px] 5xl:leading-13  2xl:text-[18px]  lg:text-[12px] xs:text-[10px] text-[12px] xs:leading-[1rem] leading-[1.3rem] text-gray-300  2xl:leading-[1.5rem] tracking-wider md:mb-8 sm:mb-8 mb-10" style={{ fontFamily: "Montserrat-Light" }}>
                            <p id="activationsParagraph">
                                At Brain Wave, animation is where imagination meets motion. Whether
                                it's for explainer videos, brand storytelling, or social media reels, we use
                                animation to simplify the complex, energize communication, and add a
                                spark of creativity to every message. From 2D and 3D animation to
                                motion graphics and kinetic typography, we animate your ideas with
                ...
                <div className="justify-end flex flex-col lg:w-[65%] md:w-[100%] sm:w-[100%] w-[100%] xs:w-[100%] items-start z-10 lg:pl-0 md:pl-0 xs:pl-0 pl-0">
                    ...
                    <div className='w-full flex items-end'>
                        <h3 id="activationsWhatWeDo" className="text-[35px]  xl:text-[35px] 5xl:text-[70px] 5xl:leading-25 md:text-[30px] 2xl:text-[45px] xs:text-[18px] font-light mb-7  tracking-wide 2xl:leading-[45px] xl:leading-[40px] sm:leading-[2rem] xs:leading-[1.5rem] leading-[2rem] subHeadingAnimation  " style={{ fontFamily: "PoppinsLight" }}>
                            <span>Our Animation Services</span>  <br />
                            <span>Include:</span>
                        </h3>
                    </div>
