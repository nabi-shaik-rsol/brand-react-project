...
import Timer from "../../assets/icons/Branding@300x.png";
...
const Branding = () => {
    const services = [
        { title: "Brand\nIdentity\nCreation", color: " bg-[#c98e27]" },
        { title: "Brand\nPositioning&\nStrategy", color: " bg-[#761a5b]" },
        { title: "Corporate\nBranding", color: " bg-[#00aa7d]" },
        { title: "Rebranding&\nBrand Refresh", color: " bg-[#e2496d]" },
        { title: "Packaging &\nProduct\nBranding", color: "bg-[#c31c26] " },
        { title: "Event &\nCampaign\nBranding", color: " bg-[#00974d]" },
        { title: "Digital Brand\nPresence", color: " bg-[#008fbf]" },
        { title: "Co-Branding\n&Pratnership\nBranding", color: "bg-[#d37548]" }
    ];
                ...
                <div className="5xl:w-[40%]   2xl:w-[35%] lg:w-[35%] md:w-[100%] sm:w-[100%] w-[100%]  z-10">
                    ...
                    <div className="w-full">
                        ...
                        >
                            ...
                            <span>Identities.</span><br />
                            <span>Building</span><br />
                            <span>Legacies.</span><br />
                        </h2>
                        ...
                        <div className="space-y-6  5xl:text-[32px] 5xl:leading-13  2xl:text-[18px]  lg:text-[12px] xs:text-[10px] text-[12px] xs:leading-[1rem] leading-[1.3rem] text-gray-300  2xl:leading-[1.5rem] tracking-wider md:mb-8 sm:mb-8 mb-10" style={{ fontFamily: "Montserrat-Light" }}>
                            <p id="activationsParagraph">
                                At Brain Wave, branding is more than just a logo — it's the soul of your
                                business. We build brands that speak, connect, and endure. Whether
                                you're launching from scratch or reinventing an existing identity, our
                                branding services shape how your audience sees you, remembers you,
                                and engages with you. We translate vision into visuals, strategy into
                                storytelling, and presence into power.
                            </p>
                ...
                <div className="justify-end flex flex-col lg:w-[65%] md:w-[100%] sm:w-[100%] w-[100%] xs:w-[100%] items-start z-10 lg:pl-0 md:pl-0 xs:pl-0 pl-0">
                    ...
                    <div className='w-full flex items-end'>
                        <h3 id="activationsWhatWeDo" className="text-[25px] w-full lg:text-[30px]  xl:text-[35px] 5xl:text-[70px] 5xl:leading-25 md:text-[30px] 2xl:text-[45px] xs:text-[25px] font-light mb-7  tracking-wide 2xl:leading-[45px] xl:leading-[40px] sm:leading-[2rem] xs:leading-[1.5rem] leading-[2rem] subHeadingAnimation  " style={{ fontFamily: "PoppinsLight" }}>
                            <span>Our Branding Services</span> <br />
                            <span>Include:</span>
                        </h3>
                    </div>
