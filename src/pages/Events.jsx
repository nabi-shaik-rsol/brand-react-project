...
import Timer from "../../assets/icons/Events@300x.png";
...
const Events = () => {
    ...
    const services = [
        { title: "Corporate &\nBrand Events", color: "bg-[#c31c26]" },
        { title: "Public &\nCommunity\nEvents", color: "bg-[#00974d]" },
        { title: "Internal &\nEmployee\nEvents", color: "bg-[#008fbf]" },
        { title: "Themed\nExperience &\nGalaDinners", color: " bg-[#d37548]" },
        { title: "Fashion,\nLifestyle &\nArt Events", color: " bg-[#c98e27] " },
        { title: "Media &\nInfluencer\nEvents", color: " bg-[#761a5b] " },
        { title: "Digital &\nHybrid\nEvevents", color: "  bg-[#00aa7d]" },
        { title: "Full-Service\nEvent\nManagement", color: "bg-[#e2496d] " }
    ];
                ...
                <div className="5xl:w-[40%]   2xl:w-[35%] lg:w-[35%] md:w-[100%] sm:w-[100%] w-[100%]  z-10">
                    ...
                    <div className="w-full">
                        <h2
                            ...
                            className="2xl:text-[70px] xl:text-[40px] md:text-[40px] text-[35px] text-bolder  mb-8 tracking-wide 2xl:leading-[4.5rem] xl:leading-[50px] leading-[2.6rem] md:leading-[2.7rem] subHeadingAnimation"
                            style={{ fontFamily: "PoppinsRegular" }}
                        >
                            <span>From Planning</span>
                            <br className="lg:block md:hidden hidden" />
                            <span>to Applause -</span>
                            <br />
                        ...
                        <div className="space-y-6  5xl:text-[32px] 5xl:leading-13  2xl:text-[18px]  lg:text-[12px] xs:text-[10px] text-[12px] xs:leading-[1rem] leading-[1.3rem] text-gray-300  2xl:leading-[1.5rem] tracking-wider md:mb-8 sm:mb-8 mb-10" style={{ fontFamily: "Montserrat-Light" }}>
                            <p id="activationsParagraph">
                                At Brain Wave, we don't just organize events—we create moments that
                                matter. Whether it's a grand product launch, an exclusive gala, a
                                corporate conference, or a cultural celebration, we design events that
                                blend creativity, precision, and emotion. Our end-to-end event solutions
                                ensure every element reflects your brand and leaves your audience
                                inspired.
                            </p>
                ...
                <div className="justify-end flex flex-col lg:w-[65%] md:w-[100%] sm:w-[100%] w-[100%] xs:w-[100%] items-start z-10 lg:pl-0 md:pl-0 xs:pl-0 pl-0">
                    ...
                    <div className='w-full flex items-end'>
                        <h3 id="activationsWhatWeDo" className="text-[25px] w-full lg:text-[30px]  xl:text-[35px] 5xl:text-[70px] 5xl:leading-25 md:text-[30px] 2xl:text-[45px] xs:text-[25px] font-light mb-7  tracking-wide 2xl:leading-[45px] xl:leading-[40px] sm:leading-[2rem] xs:leading-[1.5rem] leading-[2rem] subHeadingAnimation  " style={{ fontFamily: "PoppinsLight" }}>
                            <span>Our Event Services</span>  <br />
                            <span>Include:</span>
                        </h3>
                    </div>
                    ...
                    >
                        {services.map((service, index) => (
                            <div
                                key={index}
                                tabIndex={index}
                                className={`${service.color} lg:p-4 grid-item  md:p-3 p-2  3xl:h-52 3xl:w-52 2xl:h-48 2xl:w-48 xl:w-36 xl:h-36 md:w-28 sm:w-28 gap-2  md:h-28 sm:h-28 w-[120px] h-[120px]  flex flex-col justify-between transition-all duration-300 hover:scale-105 cursor-pointer`}
